    ...
    return (
        <Container>
            ...
            <p>
                ...
                the use of Logo's Website, located at localhost.
            </p>

            <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Logo if you do not agree to
            ...
            <p>
                We employ the use of cookies. By accessing Logo, you agreed to
                use cookies in agreement with the Logo's Privacy Policy.{" "}
            </p>
            ...
            <p>
                Unless otherwise stated, Logo and/or its licensors own the
                intellectual property rights for all material on Logo. All
                intellectual property rights are reserved. You may access this
                from Logo for your own personal use subjected to restrictions
                set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Logo</li>
                <li>Sell, rent or sub-license material from Logo</li>
                <li>Reproduce, duplicate or copy material from Logo</li>
                <li>Redistribute content from Logo</li>
            </ul>
            ...
            <p>
                ...
                website. Logo does not filter, edit, publish or review Comments
                prior to their presence on the website. Comments do not reflect
                the views and opinions of Logo,its agents and/or affiliates.
                ...
                laws, Logo shall not be liable for the Comments or for any
            ...
            <p>
                Logo reserves the right to monitor all Comments and to remove
            ...
            <p>
                You hereby grant Logo a non-exclusive license to use, reproduce,
            ...
            <p>
                ...
                of Logo; and (d) the link is in the context of general resource
                information.
            </p>
            ...
            <p>
                ...
                by sending an e-mail to Logo. Please include your name, your
            ...
            <p>
                No use of Logo's logo or other artwork will be allowed for
